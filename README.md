...
Перед публикацией в **публичный** GitHub убедитесь, что у вас есть права на распространение всех ассетов (Marketplace/пакеты/модели/текстуры). Если права ограничены — используйте **приватный** репозиторий или исключите такие ассеты из `Content/`.