...
// Объявлен здесь для использования в других модулях без extern
BACKTOZARAYSK_API TSubclassOf<AActor> GetPickupClassForItem_Internal(const class UInventoryItemData* ItemData);
