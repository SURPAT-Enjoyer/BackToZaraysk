...
def create_ik_variables():
    ...
    anim_bp_assets = asset_registry.get_assets_by_class(unreal.AnimBlueprint.static_class(), True)
...
def setup_character():
    ...
    asset_registry = unreal.AssetRegistryHelpers.get_asset_registry()
    blueprint_assets = asset_registry.get_assets_by_class(unreal.Blueprint.static_class(), True)
