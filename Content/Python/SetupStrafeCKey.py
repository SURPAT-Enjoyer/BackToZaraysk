...
def setup_blueprint_player_c():
    ...
    try:
        for function in bp_player.functions:
            if function.get_name() == "Handle C Input":
...
def main():
    ...
    try:
        ...
        print("2. Проверьте Event Graph на наличие Input Event:")
        print("   - IA_C Started → Handle C Input")
        print("3. Убедитесь, что функция Handle C Input вызывает Parent Function")
        print("4. Соберите проект: .\\build_ue53.bat")
        print("5. Протестируйте: Нажмите C для стрейфа вправо")
