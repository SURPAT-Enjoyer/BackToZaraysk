...
# УЛЬТРА-ПРОСТАЯ РАБОЧАЯ АВТОМАТИЧЕСКАЯ НАСТРОЙКА ANIMATION BLUEPRINT ДЛЯ IK
# Этот скрипт использует ультра-простой подход без устаревшего API

def ultra_simple_working_animation_blueprint_setup():
    """Ультра-простая рабочая автоматическая настройка Animation Blueprint для IK"""
    
    print("🤖 УЛЬТРА-ПРОСТАЯ РАБОЧАЯ АВТОМАТИЧЕСКАЯ НАСТРОЙКА ANIMATION BLUEPRINT ДЛЯ IK")
    print("=" * 80)
    ...
    try:
        ...
        setup_animation_blueprint_ultra_simple_working()
        
        print("\n✅ УЛЬТРА-ПРОСТАЯ РАБОЧАЯ АВТОМАТИЧЕСКАЯ НАСТРОЙКА ANIMATION BLUEPRINT ЗАВЕРШЕНА!")
...
def setup_animation_blueprint_ultra_simple_working():
    """Ультра-простая рабочая настройка Animation Blueprint"""
    
    print("Ультра-простая рабочая настройка Animation Blueprint...")
    
    # Ищем Animation Blueprint в проекте
    print("Поиск Animation Blueprint в проекте...")
    find_and_setup_animation_blueprint_ultra_simple_working()
    
    print("✅ Animation Blueprint настроен ультра-просто рабоче!")

def find_and_setup_animation_blueprint_ultra_simple_working():
    """Находит и настраивает Animation Blueprint ультра-просто рабоче"""
            ...
            for asset_data in anim_bp_assets:
                try:
                    ...
                    if anim_bp:
                        ...
                        setup_single_animation_blueprint_ultra_simple_working(anim_bp)
...
def setup_single_animation_blueprint_ultra_simple_working(anim_bp):
    """Настраивает один Animation Blueprint ультра-просто рабоче"""
    
    print("    Настройка Animation Blueprint...")
    
    # Создаем переменные IK
    print("    Создание переменных IK...")
    create_ik_variables_ultra_simple_working(anim_bp)
    
    # Создаем IK ноды
    print("    Создание IK нод...")
    create_ik_nodes_ultra_simple_working(anim_bp)
    
    print("    ✅ Animation Blueprint настроен ультра-просто рабоче!")

def create_ik_variables_ultra_simple_working(anim_bp):
    """Создает переменные IK в Animation Blueprint ультра-просто рабоче"""
...
def create_ik_nodes_ultra_simple_working(anim_bp):
    """Создает IK ноды в Animation Blueprint ультра-просто рабоче"""
...
# УЛЬТРА-ПРОСТАЯ РАБОЧАЯ АВТОМАТИЧЕСКАЯ НАСТРОЙКА ANIMATION BLUEPRINT
ultra_simple_working_animation_blueprint_setup()
